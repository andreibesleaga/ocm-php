...
use Ocm\ServiceContracts\CommentContract;

/**
 * @phpstan-import-type RequestOpts from \Ocm\RequestOptions
 */
final class CommentService implements CommentContract
{
    /**
     * @api
     */
    public CommentRawService $raw;
    ...
    {
        $this->raw = new CommentRawService($client);
    }
