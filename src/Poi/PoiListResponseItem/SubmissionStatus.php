 ...
 *
 * @phpstan-type SubmissionStatusShape = array{
 *   id: int, isLive: bool, title?: string|null
 * }
 */
final class SubmissionStatus implements BaseModel
{
    /** @use SdkModel<SubmissionStatusShape> */
    use SdkModel;
    ...
    /**
     * `new SubmissionStatus()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SubmissionStatus::with(id: ..., isLive: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SubmissionStatus)->withID(...)->withIsLive(...)
     * ```
     */
