 ...
 *
 * @phpstan-type UserCommentTypeShape = array{id?: int|null, title?: string|null}
 */
final class UserCommentType implements BaseModel
{
    /** @use SdkModel<UserCommentTypeShape> */
    use SdkModel;
