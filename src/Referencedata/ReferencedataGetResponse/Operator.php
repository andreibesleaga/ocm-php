...
use Ocm\Referencedata\ReferencedataGetResponse\Operator\AddressInfo;

/**
 * An Operator is the public organisation which controls a network of charging points.
 *
 * @phpstan-import-type AddressInfoShape from \Ocm\Referencedata\ReferencedataGetResponse\Operator\AddressInfo
 *
 * @phpstan-type OperatorShape = array{
 *   id: int,
 ...
 * }
 */
final class Operator implements BaseModel
{
    /** @use SdkModel<OperatorShape> */
    use SdkModel;
    ...
    /**
     * `new Operator()` is missing required properties by the API.
     *
